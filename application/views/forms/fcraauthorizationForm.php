...
$formname = 'FCRA Authorization to Obtain a Consumer Report FORM';
$prompt_message = '<span class="required-info">* Required Information</span>';
require_once 'config.php';
if ($_POST){
	if( empty($_POST['Name']) ||
		  empty($_POST['Applicant_Name']) ||
    	empty($_POST['Date'])
	...
	// 	{ $prompt_message = '<div id="recaptcha-error"><div class="message"><span>Please enter a valid email address</span><br/><p class="rclose">x</p></div></div>';
		...
		$body = '<div class="form_table" style="width:700px; height:auto; font-size:12px; color:#333333; letter-spacing:1px; line-height:20px; margin: 0 auto;">
			...
			foreach($_POST as $key => $value){
				...
				elseif($key == 'Company_Name') continue;
				...
				if(!empty($value)){
					...
					if($value == ':') {
						...
						Pursuant to the federal Fair Credit Reporting Act, I hereby authorize Bethel Group LLC and its designated agents and representatives to conduct a comprehensive review of my background through a consumer report and/or an investigative consumer report to be generated for employment, promotion, reassignment or retention as an employee. I understand that the scope of the consumer report/investigative consumer report may include, but is not limited to, the following areas: verification of Social Security number; current and previous residences; employment history, including all personnel files; education; references; credit history and reports; criminal history, including records from any criminal justice agency in any or all federal, state or county jurisdictions; birth records; motor vehicle records, including traffic citations and registration; and any other public records.
						</td></tr>';
				 	}else if($key == "Docu02"){
								$body .= '<tr><td colspan="2" line-height:30px"><input type="checkbox" name="" value="" checked disabled />  I '.$_POST['Name'].', authorize the complete release of these records or data pertaining to me that an individual, company, firm, corporation or public agency may have. I hereby authorize and request any present or former employer, school, police department, financial institution or other persons having personal knowledge of me to furnish '.$_POST['Company_Name'].' or its designated agents with any and all information in their possession regarding me in connection with an application of employment. I am authorizing that a photocopy of this authorization be accepted with the same authority as the original.</td></tr>';
					}else if($key == "Docu03"){
								$body .= '<tr><td colspan="2" line-height:30px"><input type="checkbox" name="" value="" checked disabled />  I understand that, pursuant to the federal Fair Credit Reporting Act, if any adverse action is to be taken based upon the consumer report, a copy of the report and a summary of the consumer’s rights will be provided to me. </td></tr>';
					}else {
		...
		<style>
           ...
           .requiredtest{line-height: 25px;}
					 .aknowled { background: rgba(12,60,99,.8); padding: 10px; text-transform: uppercase; text-align: center; font-weight: bold; color: #ffff; }
					 	.towho { margin-top: 20px; } .towhom{border-top: none; border-right: none; border-left: none; max-width: 100%; width: 35%; padding: 0 10px; height: 17px; }
										 ...
										 <div class="main fieldbox">
													<div class="fieldbox">
													 <div class="fieldheader">
														 <p>FCRA Authorization to Obtain a Consumer Report (Background/Credit Check)</p>
														 <input type="hidden" name="FCRA Authorization to Obtain a Consumer Report (Background/Credit Check)" value=":">
													 </div>
													 <div class="fieldcontent">
												   <p class="requiredtest">
														Pursuant to the federal Fair Credit Reporting Act, I hereby authorize <mark class="comp">Bethel Group LLC</mark> and its designated agents and representatives to conduct a comprehensive review of my background through a consumer report and/or an investigative consumer report to be generated for employment, promotion, reassignment or retention as an employee. I understand that the scope of the consumer report/investigative consumer report may include, but is not limited to, the following areas: verification of Social Security number; current and previous residences; employment history, including all personnel files; education; references; credit history and reports; criminal history, including records from any criminal justice agency in any or all federal, state or county jurisdictions; birth records; motor vehicle records, including traffic citations and registration; and any other public records.

													 </p>
													 <input type="checkbox" name="Docu01" style="display:none;" checked>

								          <p> <input type="checkbox" name="Docu02" style="-webkit-appearance:checkbox;">	I <input type="text" class="form_field towhom" name="Name" placeholder="Enter name here">, authorize the complete release of these records or data pertaining to me that an individual, company, firm, corporation or public agency may have. I hereby authorize and request any present or former employer, school, police department, financial institution or other persons having personal knowledge of me to furnish <input type="text" class="form_field towhom" name="Company_Name" placeholder="Enter company name here"> or its designated agents with any and all information in their possession regarding me in connection with an application of employment. I am authorizing that a photocopy of this authorization be accepted with the same authority as the original.</p>

                         <p> <input type="checkbox" name="Docu03" style="-webkit-appearance:checkbox;"> I understand that, pursuant to the federal Fair Credit Reporting Act, if any adverse action is to be taken based upon the consumer report, a copy of the report and a summary of the consumer’s rights will be provided to me.</p>
