...
$formname = 'HEPATITIS B VACCINE DECLINATION/DOCUMENTATION FORM';
				...
				if(!empty($value)){
					...
					if($value == ':') {
						...
						$body .= '<tr><td colspan="2" line-height:30px">
								...
								Declination of Hepatitis B Vaccine. <br>
								The following statement of declination of the hepatitis B vaccine must be signed by an employee who: <br>

								Chooses not to accept the vaccine. <br>
								Has had appropriate training regarding hepatitis B, hepatitis B vaccination, the efficacy, safety, method of administration and benefits of vaccination, given free of charge to the employee. <br>



						</td></tr>';
					}else if($key == "Docu02"){
						$body .= '<tr><td colspan="2" line-height:30px"> <input type="checkbox" name="" value="" checked disabled /> I understand that due to my occupational exposure to blood or other potentially infectious materials I may be at risk of acquiring hepatitis B virus (HBV) infection. I have been given the opportunity to be vaccinated with hepatitis B vaccine, at no charge to myself. However, I decline hepatitis B vaccination at this time. I understand that by declining this vaccine I continue to be at risk of acquiring hepatitis B, a serious disease. If in the future I continue to have occupational exposure to blood or other potentially infectious materials and I want to be vaccinated with hepatitis B vaccine, I can receive the vaccination series at no charge to me. </td></tr>';
					}else {
										 ...
										 <div class="main fieldbox">
													<div class="fieldbox">
													 <div class="fieldheader">
														 <p>HEPATITIS B VACCINE DECLINATION/DOCUMENTATION</p>
														 <input type="hidden" name="HEPATITIS B VACCINE DECLINATION/DOCUMENTATION" value=":">
													 </div>
												   ...
												   <p class="requiredtest">
														   Declination of Hepatitis B Vaccine. <br>
															 The following statement of declination of the hepatitis B vaccine must be signed by an employee who: <br>
															 <ul>
															 	 <li>Chooses <strong>not</strong> to accept the vaccine. </li>
													 ...
													 <input type="checkbox" name="Docu02" style="-webkit-appearance:checkbox;"> I understand that due to my occupational exposure to blood or other potentially infectious materials I may be at risk of acquiring hepatitis B virus (HBV) infection. I have been given the opportunity to be vaccinated with hepatitis B vaccine, at no charge to myself. However, I decline hepatitis B vaccination at this time. I understand that by declining this vaccine I continue to be at risk of acquiring hepatitis B, a serious disease. If in the future I continue to have occupational exposure to blood or other potentially infectious materials and I want to be vaccinated with hepatitis B vaccine, I can receive the vaccination series at no charge to me.</p>
